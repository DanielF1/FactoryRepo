...
public class CognacFactoryDataInitializer implements DataInitializer {
	...
	private void initializeLocationsUsersAndStock(	LocationRepository locationRepository, 
		...
		incomeRepository.save(new Income("Hans Klausen", LocalDate.of(2014, 1, 12), 4526.90, "Produktkauf"));
		...
		incomeRepository.save(new Income("Dieter Petersen", LocalDate.of(2014, 6, 2), 926.00, "Produktkauf"));
		...
		incomeRepository.save(new Income("Harry Potter", LocalDate.of(2014, 12, 9), 6226.00, "Produktkauf"));
		incomeRepository.save(new Income("Frodo Beutlin", LocalDate.of(2015, 1, 10), 1426.50, "Produktkauf"));
	}
